...
let check_sticky_all_to_occupied ({ Harness.oxctl; _ } as h) =
  Harness.with_windows "check sticky all to occupied" h [ "kitty", 1; "emacs", 2 ]
  @@ fun () ->
  oxctl "window toggle sticky all";
  oxctl "tag view 2";
...
let () =
  ...
  check_sticky_all_to_occupied h;
