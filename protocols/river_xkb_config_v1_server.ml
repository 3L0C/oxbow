...
module River_xkb_config_v1 = struct
  ...
  let xkb_keyboard (_t:([< `V1 | `V2] as 'v) t) (id:([`River_xkb_keyboard_v1], 'v, [`Server]) #Proxy.Handler.t) =
  ...
  class virtual ['v] _handlers_unsafe = object (_self : (_, 'v, _) #Proxy.Handler.t)
    ...
    method private virtual on_create_keymap : [> ] t -> ([`River_xkb_keymap_v1], 'v, [`Server]) Proxy.t ->
                                              fd:Unix.file_descr ->
                                              format:Imports.River_xkb_config_v1.Keymap_format.t -> unit
    ...
    method dispatch (_proxy : 'v t) _msg =
      ...
      | 2 ->
        let id : ([`River_xkb_keymap_v1], _, _) Proxy.t =
          Msg.get_int _msg |> Proxy.Handler.accept_new _proxy (module Imports.River_xkb_keymap_v1) in
        let fd = Msg.get_fd _msg in
        let format = Msg.get_int _msg |> Imports.River_xkb_config_v1.Keymap_format.of_int32 in
  ...
  class virtual ['v] v1 = object (_ : (_, 'v, _) #Proxy.Service_handler.t)
    ...
    method private virtual on_create_keymap : [> `V1 | `V2] t -> ([`River_xkb_keymap_v1], 'v, [`Server]) Proxy.t ->
                                              fd:Unix.file_descr ->
                                              format:Imports.River_xkb_config_v1.Keymap_format.t -> unit
  ...
  class virtual ['v] v2 = object (_ : (_, 'v, _) #Proxy.Service_handler.t)
    ...
    method private virtual on_create_keymap : [> `V2] t -> ([`River_xkb_keymap_v1], 'v, [`Server]) Proxy.t ->
                                              fd:Unix.file_descr ->
                                              format:Imports.River_xkb_config_v1.Keymap_format.t -> unit
...
module River_xkb_keyboard_v1 = struct
  ...
  class virtual ['v] _handlers_unsafe = object (_self : (_, 'v, _) #Proxy.Handler.t)
    ...
    method private virtual on_set_keymap : [> ] t -> keymap:([`River_xkb_keymap_v1], [> Imports.River_xkb_keymap_v1.versions], [`Server]) Proxy.t ->
                                           unit
    ...
    method dispatch (_proxy : 'v t) _msg =
      ...
      | 4 ->
        _self#on_capslock_enable _proxy 
      | 5 ->
        _self#on_capslock_disable _proxy 
      | 6 ->
        _self#on_numlock_enable _proxy 
      | 7 ->
        _self#on_numlock_disable _proxy 
      | _ -> assert false
  end
  (**/**)
  ...
  class virtual ['v] v1 = object (_ : (_, 'v, _) #Proxy.Service_handler.t)
    ...
    method private virtual on_set_keymap : [> `V1 | `V2] t -> keymap:([`River_xkb_keymap_v1], [> Imports.River_xkb_keymap_v1.versions], [`Server]) Proxy.t ->
                                           unit
    ...
    method private virtual on_set_layout_by_index : [> `V1 | `V2] t -> index:int32 -> unit
    ...
    method private virtual on_set_layout_by_name : [> `V1 | `V2] t -> name:string -> unit
  ...
  class virtual ['v] v2 = object (_ : (_, 'v, _) #Proxy.Service_handler.t)
    ...
    method private virtual on_set_keymap : [> `V2] t -> keymap:([`River_xkb_keymap_v1], [> Imports.River_xkb_keymap_v1.versions], [`Server]) Proxy.t ->
                                           unit
