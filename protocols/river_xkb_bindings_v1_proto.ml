...
module River_xkb_bindings_v1 = struct
  ...
  let requests = function
    | 0 -> "destroy", []
    | 1 -> "get_xkb_binding", ["seat", `Object (Some "river_seat_v1"); "id", `New_ID (Some "river_xkb_binding_v1");
                               "keysym", `Uint; "modifiers", `Uint]
    | 2 -> "get_seat", ["id", `New_ID (Some "river_xkb_bindings_seat_v1"); "seat", `Object (Some "river_seat_v1")]
