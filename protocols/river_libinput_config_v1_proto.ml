...
module River_libinput_config_v1 = struct
  ...
  let requests = function
    | 0 -> "stop", []
    | 1 -> "destroy", []
    | 2 -> "create_accel_config", ["id", `New_ID (Some "river_libinput_accel_config_v1"); "profile", `Uint]
...
module River_libinput_device_v1 = struct
  ...
  let requests = function
    | 0 -> "destroy", []
    | 1 -> "set_send_events", ["result", `New_ID (Some "river_libinput_result_v1"); "mode", `Uint]
    | 2 -> "set_tap", ["result", `New_ID (Some "river_libinput_result_v1"); "state", `Uint]
    | 3 -> "set_tap_button_map", ["result", `New_ID (Some "river_libinput_result_v1"); "button_map", `Uint]
    | 4 -> "set_drag", ["result", `New_ID (Some "river_libinput_result_v1"); "state", `Uint]
    | 5 -> "set_drag_lock", ["result", `New_ID (Some "river_libinput_result_v1"); "state", `Uint]
    | 6 -> "set_three_finger_drag", ["result", `New_ID (Some "river_libinput_result_v1"); "state", `Uint]
    | 7 -> "set_calibration_matrix", ["result", `New_ID (Some "river_libinput_result_v1"); "matrix", `Array]
    | 8 -> "set_accel_profile", ["result", `New_ID (Some "river_libinput_result_v1"); "profile", `Uint]
    | 9 -> "set_accel_speed", ["result", `New_ID (Some "river_libinput_result_v1"); "speed", `Array]
    | 10 -> "apply_accel_config", ["result", `New_ID (Some "river_libinput_result_v1");
                                   "config", `Object (Some "river_libinput_accel_config_v1")]
    | 11 -> "set_natural_scroll", ["result", `New_ID (Some "river_libinput_result_v1"); "state", `Uint]
    | 12 -> "set_left_handed", ["result", `New_ID (Some "river_libinput_result_v1"); "state", `Uint]
    | 13 -> "set_click_method", ["result", `New_ID (Some "river_libinput_result_v1"); "method", `Uint]
    | 14 -> "set_clickfinger_button_map", ["result", `New_ID (Some "river_libinput_result_v1"); "button_map", `Uint]
    | 15 -> "set_middle_emulation", ["result", `New_ID (Some "river_libinput_result_v1"); "state", `Uint]
    | 16 -> "set_scroll_method", ["result", `New_ID (Some "river_libinput_result_v1"); "method", `Uint]
    | 17 -> "set_scroll_button", ["result", `New_ID (Some "river_libinput_result_v1"); "button", `Uint]
    | 18 -> "set_scroll_button_lock", ["result", `New_ID (Some "river_libinput_result_v1"); "state", `Uint]
    | 19 -> "set_dwt", ["result", `New_ID (Some "river_libinput_result_v1"); "state", `Uint]
    | 20 -> "set_dwtp", ["result", `New_ID (Some "river_libinput_result_v1"); "state", `Uint]
    | 21 -> "set_rotation", ["result", `New_ID (Some "river_libinput_result_v1"); "angle", `Uint]
    | i -> Proxy.unknown_request i, []
...
module River_libinput_accel_config_v1 = struct
  ...
  let requests = function
    | 0 -> "destroy", []
    | 1 -> "set_points", ["result", `New_ID (Some "river_libinput_result_v1"); "type", `Uint; "step", `Array;
                          "points", `Array]
    | i -> Proxy.unknown_request i, []
