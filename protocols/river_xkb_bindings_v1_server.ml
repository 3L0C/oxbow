...
module River_xkb_bindings_v1 = struct
  type 'v t = ([`River_xkb_bindings_v1], 'v, [`Server]) Proxy.t
  ...
  class virtual ['v] _handlers_unsafe = object (_self : (_, 'v, _) #Proxy.Handler.t)
    ...
    method private virtual on_get_xkb_binding : [> ] t -> seat:([`River_seat_v1], [> Imports.River_seat_v1.versions], [`Server]) Proxy.t ->
                                                ([`River_xkb_binding_v1], 'v, [`Server]) Proxy.t -> keysym:int32 ->
                                                modifiers:Imports.River_seat_v1.Modifiers.t -> unit
    
    method private virtual on_get_seat : [> ] t -> ([`River_xkb_bindings_seat_v1], 'v, [`Server]) Proxy.t ->
    ...
    method dispatch (_proxy : 'v t) _msg =
      ...
      | 1 ->
        let seat : ([`River_seat_v1], _, _) Proxy.t =
          ...
          in
        let id : ([`River_xkb_binding_v1], _, _) Proxy.t =
          Msg.get_int _msg |> Proxy.Handler.accept_new _proxy (module Imports.River_xkb_binding_v1) in
        let keysym = Msg.get_int _msg in
        let modifiers = Msg.get_int _msg |> Imports.River_seat_v1.Modifiers.of_int32 in
        _self#on_get_xkb_binding _proxy ~seat id ~keysym ~modifiers
      | 2 ->
        let id : ([`River_xkb_bindings_seat_v1], _, _) Proxy.t =
          Msg.get_int _msg |> Proxy.Handler.accept_new _proxy (module Imports.River_xkb_bindings_seat_v1) in
        let seat : ([`River_seat_v1], _, _) Proxy.t =
          let Proxy.Proxy p = Msg.get_int _msg |> Proxy.lookup_other _proxy in
          match Proxy.ty p with
          | Imports.River_seat_v1.T -> p
  ...
  class virtual ['v] v1 = object (_ : (_, 'v, _) #Proxy.Service_handler.t)
    ...
    method private virtual on_get_xkb_binding : [> `V1 | `V2 | `V3] t -> seat:([`River_seat_v1], [> Imports.River_seat_v1.versions], [`Server]) Proxy.t ->
                                                ([`River_xkb_binding_v1], 'v, [`Server]) Proxy.t -> keysym:int32 ->
                                                modifiers:Imports.River_seat_v1.Modifiers.t -> unit
    ...
    method private virtual on_get_seat : [> `V2 | `V3] t -> ([`River_xkb_bindings_seat_v1], 'v, [`Server]) Proxy.t ->
                                         seat:([`River_seat_v1], [> Imports.River_seat_v1.versions], [`Server]) Proxy.t ->
                                         unit
  ...
  class virtual ['v] v2 = object (_ : (_, 'v, _) #Proxy.Service_handler.t)
    ...
    method private virtual on_get_xkb_binding : [> `V2 | `V3] t -> seat:([`River_seat_v1], [> Imports.River_seat_v1.versions], [`Server]) Proxy.t ->
                                                ([`River_xkb_binding_v1], 'v, [`Server]) Proxy.t -> keysym:int32 ->
                                                modifiers:Imports.River_seat_v1.Modifiers.t -> unit
  ...
  class virtual ['v] v3 = object (_ : (_, 'v, _) #Proxy.Service_handler.t)
    ...
    method private virtual on_get_xkb_binding : [> `V3] t -> seat:([`River_seat_v1], [> Imports.River_seat_v1.versions], [`Server]) Proxy.t ->
                                                ([`River_xkb_binding_v1], 'v, [`Server]) Proxy.t -> keysym:int32 ->
                                                modifiers:Imports.River_seat_v1.Modifiers.t -> unit
    ...
    method private virtual on_get_seat : [> `V3] t -> ([`River_xkb_bindings_seat_v1], 'v, [`Server]) Proxy.t ->
                                         seat:([`River_seat_v1], [> Imports.River_seat_v1.versions], [`Server]) Proxy.t ->
                                         unit
...
module River_xkb_binding_v1 = struct
  type 'v t = ([`River_xkb_binding_v1], 'v, [`Server]) Proxy.t
  ...
  let released (_t:([< `V1 | `V2 | `V3] as 'v) t)  =
  ...
  (** The key triggering the binding has been pressed.
      ...
      as soon as possible as the capacity of the compositor to buffer incoming
      input events is finite. *)
  let pressed (_t:([< `V1 | `V2 | `V3] as 'v) t)  =
  ...
  (** Repeating should be stopped.
      ...
      This event will be followed by a manage_start event after all other new
      state has been sent by the server. *)
  let stop_repeat (_t:([< `V2 | `V3] as 'v) t)  =
  ...
  class virtual ['v] _handlers_unsafe = object (_self : (_, 'v, _) #Proxy.Handler.t)
    ...
    method private virtual on_set_layout_override : [> ] t -> layout:int32 -> unit
    ...
    method dispatch (_proxy : 'v t) _msg =
      ...
      | 0 ->
        ...
        _self#on_destroy _proxy 
      | 1 ->
        let layout = Msg.get_int _msg in
        _self#on_set_layout_override _proxy ~layout
      | 2 ->
  ...
  class virtual ['v] v1 = object (_ : (_, 'v, _) #Proxy.Service_handler.t)
    ...
    method private virtual on_set_layout_override : [> `V1 | `V2 | `V3] t -> layout:int32 -> unit
    ...
    method private virtual on_enable : [> `V1 | `V2 | `V3] t -> unit
    ...
    method private virtual on_disable : [> `V1 | `V2 | `V3] t -> unit
  ...
  class virtual ['v] v2 = object (_ : (_, 'v, _) #Proxy.Service_handler.t)
    ...
    method private virtual on_set_layout_override : [> `V2 | `V3] t -> layout:int32 -> unit
    ...
    method private virtual on_enable : [> `V2 | `V3] t -> unit
    ...
    method private virtual on_disable : [> `V2 | `V3] t -> unit
  ...
  class virtual ['v] v3 = object (_ : (_, 'v, _) #Proxy.Service_handler.t)
    ...
    method private virtual on_set_layout_override : [> `V3] t -> layout:int32 -> unit
    ...
    method private virtual on_enable : [> `V3] t -> unit
    ...
    method private virtual on_disable : [> `V3] t -> unit
...
module River_xkb_bindings_seat_v1 = struct
  type 'v t = ([`River_xkb_bindings_seat_v1], 'v, [`Server]) Proxy.t
  ...
  (** An unbound key press event was eaten.
      ...
      This event will be followed by a manage_start event after all other new
      state has been sent by the server. *)
  let ate_unbound_key (_t:([< `V2 | `V3] as 'v) t)  =
    let _msg = Proxy.alloc _t ~op:0 ~ints:0 ~strings:[] ~arrays:[] in
    Proxy.send _t _msg
  ...
  (** Active modifiers for the seat changed.
      ...
      as soon as possible as the capacity of the compositor to buffer incoming
      input events is finite. *)
  let modifiers_update (_t:([< `V3] as 'v) t) ~old ~new_ =
    let _msg = Proxy.alloc _t ~op:1 ~ints:2 ~strings:[] ~arrays:[] in
    Msg.add_int _msg (Imports.River_seat_v1.Modifiers.to_int32 old);
    Msg.add_int _msg (Imports.River_seat_v1.Modifiers.to_int32 new_);
    Proxy.send _t _msg
  ...
  class virtual ['v] _handlers_unsafe = object (_self : (_, 'v, _) #Proxy.Handler.t)
    ...
    method private virtual on_ensure_next_key_eaten : [> ] t -> unit
    
    method private virtual on_cancel_ensure_next_key_eaten : [> ] t -> unit
    
    method private virtual on_modifiers_watch : [> ] t -> modifiers:Imports.River_seat_v1.Modifiers.t -> unit
    ...
    method dispatch (_proxy : 'v t) _msg =
      ...
      | 0 ->
        ...
        _self#on_destroy _proxy 
      | 1 ->
        _self#on_ensure_next_key_eaten _proxy 
      | 2 ->
        _self#on_cancel_ensure_next_key_eaten _proxy 
      | 3 ->
        let modifiers = Msg.get_int _msg |> Imports.River_seat_v1.Modifiers.of_int32 in
        _self#on_modifiers_watch _proxy ~modifiers
      | _ -> assert false
  end
  (**/**)
  ...
  class virtual ['v] v1 = object (_ : (_, 'v, _) #Proxy.Service_handler.t)
    ...
    method private virtual on_ensure_next_key_eaten : [> `V2 | `V3] t -> unit
    ...
    method private virtual on_cancel_ensure_next_key_eaten : [> `V2 | `V3] t -> unit
    ...
    method private virtual on_modifiers_watch : [> `V3] t -> modifiers:Imports.River_seat_v1.Modifiers.t -> unit
  ...
  class virtual ['v] v3 = object (_ : (_, 'v, _) #Proxy.Service_handler.t)
    ...
    method private virtual on_ensure_next_key_eaten : [> `V3] t -> unit
    ...
    method private virtual on_cancel_ensure_next_key_eaten : [> `V3] t -> unit
