...
module River_libinput_config_v1 = struct
  ...
  let libinput_device (_t:([< `V1 | `V2] as 'v) t) (id:([`River_libinput_device_v1], 'v, [`Server]) #Proxy.Handler.t) =
  ...
  class virtual ['v] _handlers_unsafe = object (_self : (_, 'v, _) #Proxy.Handler.t)
    ...
    method private virtual on_create_accel_config : [> ] t -> ([`River_libinput_accel_config_v1], 'v, [`Server]) Proxy.t ->
                                                    profile:Imports.River_libinput_device_v1.Accel_profile.t -> unit
    ...
    method dispatch (_proxy : 'v t) _msg =
      ...
      | 2 ->
        let id : ([`River_libinput_accel_config_v1], _, _) Proxy.t =
          Msg.get_int _msg |> Proxy.Handler.accept_new _proxy (module Imports.River_libinput_accel_config_v1) in
  ...
  class virtual ['v] v1 = object (_ : (_, 'v, _) #Proxy.Service_handler.t)
    ...
    method private virtual on_create_accel_config : [> `V1 | `V2] t -> ([`River_libinput_accel_config_v1], 'v, [`Server]) Proxy.t ->
                                                    profile:Imports.River_libinput_device_v1.Accel_profile.t -> unit
  ...
  class virtual ['v] v2 = object (_ : (_, 'v, _) #Proxy.Service_handler.t)
    ...
    method private virtual on_create_accel_config : [> `V2] t -> ([`River_libinput_accel_config_v1], 'v, [`Server]) Proxy.t ->
                                                    profile:Imports.River_libinput_device_v1.Accel_profile.t -> unit
...
module River_libinput_device_v1 = struct
  ...
  let input_device (_t:([< `V1 | `V2] as 'v) t) ~(device:([`River_input_device_v1], _, [`Server]) Proxy.t) =
    let _msg = Proxy.alloc _t ~op:1 ~ints:1 ~strings:[] ~arrays:[] in
  ...
  class virtual ['v] _handlers_unsafe = object (_self : (_, 'v, _) #Proxy.Handler.t)
    ...
    method private virtual on_set_send_events : [> ] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                mode:Imports.River_libinput_device_v1.Send_events_modes.t -> unit
    
    method private virtual on_set_tap : [> ] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                        state:Imports.River_libinput_device_v1.Tap_state.t -> unit
    
    method private virtual on_set_tap_button_map : [> ] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                   button_map:Imports.River_libinput_device_v1.Tap_button_map.t -> unit
    
    method private virtual on_set_drag : [> ] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                         state:Imports.River_libinput_device_v1.Drag_state.t -> unit
    
    method private virtual on_set_drag_lock : [> ] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                              state:Imports.River_libinput_device_v1.Drag_lock_state.t -> unit
    
    method private virtual on_set_three_finger_drag : [> ] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                      state:Imports.River_libinput_device_v1.Three_finger_drag_state.t ->
                                                      unit
    
    method private virtual on_set_calibration_matrix : [> ] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                       matrix:string -> unit
    
    method private virtual on_set_accel_profile : [> ] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                  profile:Imports.River_libinput_device_v1.Accel_profile.t -> unit
    
    method private virtual on_set_accel_speed : [> ] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                speed:string -> unit
    
    method private virtual on_apply_accel_config : [> ] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                   config:([`River_libinput_accel_config_v1], [> Imports.River_libinput_accel_config_v1.versions], [`Server]) Proxy.t ->
                                                   unit
    
    method private virtual on_set_natural_scroll : [> ] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                   state:Imports.River_libinput_device_v1.Natural_scroll_state.t ->
                                                   unit
    
    method private virtual on_set_left_handed : [> ] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                state:Imports.River_libinput_device_v1.Left_handed_state.t -> unit
    
    method private virtual on_set_click_method : [> ] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                 method_:Imports.River_libinput_device_v1.Click_method.t -> unit
    
    method private virtual on_set_clickfinger_button_map : [> ] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                           button_map:Imports.River_libinput_device_v1.Clickfinger_button_map.t ->
                                                           unit
    
    method private virtual on_set_middle_emulation : [> ] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                     state:Imports.River_libinput_device_v1.Middle_emulation_state.t ->
                                                     unit
    
    method private virtual on_set_scroll_method : [> ] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                  method_:Imports.River_libinput_device_v1.Scroll_method.t -> unit
    
    method private virtual on_set_scroll_button : [> ] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                  button:int32 -> unit
    
    method private virtual on_set_scroll_button_lock : [> ] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                       state:Imports.River_libinput_device_v1.Scroll_button_lock_state.t ->
                                                       unit
    
    method private virtual on_set_dwt : [> ] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                        state:Imports.River_libinput_device_v1.Dwt_state.t -> unit
    
    method private virtual on_set_dwtp : [> ] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                         state:Imports.River_libinput_device_v1.Dwtp_state.t -> unit
    
    method private virtual on_set_rotation : [> ] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                             angle:int32 -> unit
    ...
    method dispatch (_proxy : 'v t) _msg =
      ...
      | 1 ->
        let result : ([`River_libinput_result_v1], _, _) Proxy.t =
          Msg.get_int _msg |> Proxy.Handler.accept_new _proxy (module Imports.River_libinput_result_v1) in
      ...
      | 10 ->
        ...
        let config : ([`River_libinput_accel_config_v1], _, _) Proxy.t =
          ...
          | _ -> Proxy.wrong_type ~parent:_proxy ~expected:"river_libinput_accel_config_v1" p
          in
  ...
  class virtual ['v] v1 = object (_ : (_, 'v, _) #Proxy.Service_handler.t)
    ...
    method private virtual on_set_send_events : [> `V1 | `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                mode:Imports.River_libinput_device_v1.Send_events_modes.t -> unit
    ...
    method private virtual on_set_tap : [> `V1 | `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                        state:Imports.River_libinput_device_v1.Tap_state.t -> unit
    ...
    method private virtual on_set_tap_button_map : [> `V1 | `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                   button_map:Imports.River_libinput_device_v1.Tap_button_map.t -> unit
    ...
    method private virtual on_set_drag : [> `V1 | `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                         state:Imports.River_libinput_device_v1.Drag_state.t -> unit
    ...
    method private virtual on_set_drag_lock : [> `V1 | `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                              state:Imports.River_libinput_device_v1.Drag_lock_state.t -> unit
    ...
    method private virtual on_set_three_finger_drag : [> `V1 | `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                      state:Imports.River_libinput_device_v1.Three_finger_drag_state.t ->
                                                      unit
    ...
    method private virtual on_set_calibration_matrix : [> `V1 | `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                       matrix:string -> unit
    ...
    method private virtual on_set_accel_profile : [> `V1 | `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                  profile:Imports.River_libinput_device_v1.Accel_profile.t -> unit
    ...
    method private virtual on_set_accel_speed : [> `V1 | `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                speed:string -> unit
    ...
    method private virtual on_apply_accel_config : [> `V1 | `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                   config:([`River_libinput_accel_config_v1], [> Imports.River_libinput_accel_config_v1.versions], [`Server]) Proxy.t ->
                                                   unit
    ...
    method private virtual on_set_natural_scroll : [> `V1 | `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                   state:Imports.River_libinput_device_v1.Natural_scroll_state.t ->
                                                   unit
    ...
    method private virtual on_set_left_handed : [> `V1 | `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                state:Imports.River_libinput_device_v1.Left_handed_state.t -> unit
    ...
    method private virtual on_set_click_method : [> `V1 | `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                 method_:Imports.River_libinput_device_v1.Click_method.t -> unit
    ...
    method private virtual on_set_clickfinger_button_map : [> `V1 | `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                           button_map:Imports.River_libinput_device_v1.Clickfinger_button_map.t ->
                                                           unit
    ...
    method private virtual on_set_middle_emulation : [> `V1 | `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                     state:Imports.River_libinput_device_v1.Middle_emulation_state.t ->
                                                     unit
    ...
    method private virtual on_set_scroll_method : [> `V1 | `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                  method_:Imports.River_libinput_device_v1.Scroll_method.t -> unit
    ...
    method private virtual on_set_scroll_button : [> `V1 | `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                  button:int32 -> unit
    ...
    method private virtual on_set_scroll_button_lock : [> `V1 | `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                       state:Imports.River_libinput_device_v1.Scroll_button_lock_state.t ->
                                                       unit
    ...
    method private virtual on_set_dwt : [> `V1 | `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                        state:Imports.River_libinput_device_v1.Dwt_state.t -> unit
    ...
    method private virtual on_set_dwtp : [> `V1 | `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                         state:Imports.River_libinput_device_v1.Dwtp_state.t -> unit
    ...
    method private virtual on_set_rotation : [> `V1 | `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                             angle:int32 -> unit
  ...
  class virtual ['v] v2 = object (_ : (_, 'v, _) #Proxy.Service_handler.t)
    ...
    method private virtual on_set_send_events : [> `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                mode:Imports.River_libinput_device_v1.Send_events_modes.t -> unit
    ...
    method private virtual on_set_tap : [> `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                        state:Imports.River_libinput_device_v1.Tap_state.t -> unit
    ...
    method private virtual on_set_tap_button_map : [> `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                   button_map:Imports.River_libinput_device_v1.Tap_button_map.t -> unit
    ...
    method private virtual on_set_drag : [> `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                         state:Imports.River_libinput_device_v1.Drag_state.t -> unit
    ...
    method private virtual on_set_drag_lock : [> `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                              state:Imports.River_libinput_device_v1.Drag_lock_state.t -> unit
    ...
    method private virtual on_set_three_finger_drag : [> `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                      state:Imports.River_libinput_device_v1.Three_finger_drag_state.t ->
                                                      unit
    ...
    method private virtual on_set_calibration_matrix : [> `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                       matrix:string -> unit
    ...
    method private virtual on_set_accel_profile : [> `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                  profile:Imports.River_libinput_device_v1.Accel_profile.t -> unit
    ...
    method private virtual on_set_accel_speed : [> `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                speed:string -> unit
    ...
    method private virtual on_apply_accel_config : [> `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                   config:([`River_libinput_accel_config_v1], [> Imports.River_libinput_accel_config_v1.versions], [`Server]) Proxy.t ->
                                                   unit
    ...
    method private virtual on_set_natural_scroll : [> `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                   state:Imports.River_libinput_device_v1.Natural_scroll_state.t ->
                                                   unit
    ...
    method private virtual on_set_left_handed : [> `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                state:Imports.River_libinput_device_v1.Left_handed_state.t -> unit
    ...
    method private virtual on_set_click_method : [> `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                 method_:Imports.River_libinput_device_v1.Click_method.t -> unit
    ...
    method private virtual on_set_clickfinger_button_map : [> `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                           button_map:Imports.River_libinput_device_v1.Clickfinger_button_map.t ->
                                                           unit
    ...
    method private virtual on_set_middle_emulation : [> `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                     state:Imports.River_libinput_device_v1.Middle_emulation_state.t ->
                                                     unit
    ...
    method private virtual on_set_scroll_method : [> `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                  method_:Imports.River_libinput_device_v1.Scroll_method.t -> unit
    ...
    method private virtual on_set_scroll_button : [> `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                  button:int32 -> unit
    ...
    method private virtual on_set_scroll_button_lock : [> `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                                       state:Imports.River_libinput_device_v1.Scroll_button_lock_state.t ->
                                                       unit
    ...
    method private virtual on_set_dwt : [> `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                        state:Imports.River_libinput_device_v1.Dwt_state.t -> unit
    ...
    method private virtual on_set_dwtp : [> `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                         state:Imports.River_libinput_device_v1.Dwtp_state.t -> unit
    ...
    method private virtual on_set_rotation : [> `V2] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                             angle:int32 -> unit
...
module River_libinput_accel_config_v1 = struct
  ...
  class virtual ['v] _handlers_unsafe = object (_self : (_, 'v, _) #Proxy.Handler.t)
    ...
    method private virtual on_set_points : [> ] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                           type_:Imports.River_libinput_accel_config_v1.Accel_type.t -> step:string ->
                                           points:string -> unit
    ...
    method dispatch (_proxy : 'v t) _msg =
      ...
      | 1 ->
        let result : ([`River_libinput_result_v1], _, _) Proxy.t =
          Msg.get_int _msg |> Proxy.Handler.accept_new _proxy (module Imports.River_libinput_result_v1) in
        let type_ = Msg.get_int _msg |> Imports.River_libinput_accel_config_v1.Accel_type.of_int32 in
  ...
  class virtual ['v] v1 = object (_ : (_, 'v, _) #Proxy.Service_handler.t)
    ...
    method private virtual on_set_points : [> `V1] t -> ([`River_libinput_result_v1], 'v, [`Server]) Proxy.t ->
                                           type_:Imports.River_libinput_accel_config_v1.Accel_type.t -> step:string ->
                                           points:string -> unit
