...
let create (wm : Window_manager.t) (river_window : [ `V4 ] Rwm.River_window_v1.t) : t =
  let node =
    object
...
let queue_request (w : t) (r : Window_request.t) = w.requests <- r :: w.requests
