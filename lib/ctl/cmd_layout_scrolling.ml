...
let cmd =
  build
    ...
    [ Cmd_layout_scrolling_default_width.cmd; Cmd_layout_scrolling_policy.cmd ]
;;

let bind_cmd =
  build
    Ctl_cli.bind_term
    [ Cmd_layout_scrolling_default_width.bind_cmd; Cmd_layout_scrolling_policy.bind_cmd ]
;;
