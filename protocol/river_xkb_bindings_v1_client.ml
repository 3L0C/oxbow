...
module River_xkb_bindings_v1 = struct
  ...
  let get_xkb_binding (_t:([< `V1 | `V2 | `V3] as 'v) t) ~(seat:([`River_seat_v1], _, [`Client]) Proxy.t) (id:([`River_xkb_binding_v1], 'v, [`Client]) #Proxy.Handler.t) ~keysym ~modifiers =
  ...
  let get_seat (_t:([< `V2 | `V3] as 'v) t) (id:([`River_xkb_bindings_seat_v1], 'v, [`Client]) #Proxy.Handler.t) ~(seat:([`River_seat_v1], _, [`Client]) Proxy.t) =
    let __id = Proxy.spawn _t id in
...
module River_xkb_bindings_seat_v1 = struct
  ...
  class virtual ['v] _handlers_unsafe = object (_self : (_, 'v, _) #Proxy.Handler.t)
    ...
    method private virtual on_modifiers_update : [> ] t -> old:Imports.River_seat_v1.Modifiers.t ->
                                                 new_:Imports.River_seat_v1.Modifiers.t -> unit
    ...
    method dispatch (_proxy : 'v t) _msg =
      ...
      match Msg.op _msg with
      | 0 ->
        _self#on_ate_unbound_key _proxy 
      | 1 ->
  ...
  class virtual ['v] v1 = object (_ : (_, 'v, _) #Proxy.Service_handler.t)
    ...
    method private virtual on_modifiers_update : [> `V3] t -> old:Imports.River_seat_v1.Modifiers.t ->
                                                 new_:Imports.River_seat_v1.Modifiers.t -> unit
