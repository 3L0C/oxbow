...
module River_xkb_config_v1 = struct
  ...
  let create_keymap
        (_t : ([< `V1 | `V2 ] as 'v) t)
        (id : ([ `River_xkb_keymap_v1 ], 'v, [ `Client ]) #Proxy.Handler.t)
        ~fd
        ~format
    =
  ...
  class virtual ['v] _handlers_unsafe =
    object (_self : (_, 'v, _) #Proxy.Handler.t)
      ...
      method
        private
        virtual on_xkb_keyboard
        : [> ] t -> ([ `River_xkb_keyboard_v1 ], 'v, [ `Client ]) Proxy.t -> unit
      ...
      method dispatch (_proxy : 'v t) _msg =
        ...
        | 1 ->
          let id : ([ `River_xkb_keyboard_v1 ], _, _) Proxy.t =
            Msg.get_int _msg
            |> Proxy.Handler.accept_new _proxy (module Imports.River_xkb_keyboard_v1)
          in
  ...
  class virtual ['v] v1 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        ...
        virtual on_xkb_keyboard
        : [> `V1 | `V2 ] t
          -> ([ `River_xkb_keyboard_v1 ], 'v, [ `Client ]) Proxy.t
          -> unit
  ...
  class virtual ['v] v2 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_xkb_keyboard
        : [> `V2 ] t -> ([ `River_xkb_keyboard_v1 ], 'v, [ `Client ]) Proxy.t -> unit
...
module River_xkb_keyboard_v1 = struct
  ...
  let set_keymap
        (_t : ([< `V1 | `V2 ] as 'v) t)
        ~(keymap : ([ `River_xkb_keymap_v1 ], _, [ `Client ]) Proxy.t)
    =
  ...
  class virtual ['v] _handlers_unsafe =
    object (_self : (_, 'v, _) #Proxy.Handler.t)
      ...
      method
        private
        virtual on_layout
        : [> ] t -> index:int32 -> name:string option -> unit
      ...
      method dispatch (_proxy : 'v t) _msg =
        ...
        | 3 -> _self#on_capslock_enabled _proxy
        | 4 -> _self#on_capslock_disabled _proxy
        | 5 -> _self#on_numlock_enabled _proxy
        | 6 -> _self#on_numlock_disabled _proxy
        | 7 -> _self#on_done _proxy
        | _ -> assert false
    end
  ...
  class virtual ['v] v1 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_layout
        : [> `V1 | `V2 ] t -> index:int32 -> name:string option -> unit
  ...
  class virtual ['v] v2 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_layout
        : [> `V2 ] t -> index:int32 -> name:string option -> unit
