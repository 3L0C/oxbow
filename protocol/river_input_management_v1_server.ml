...
module River_input_manager_v1 = struct
  ...
  let input_device (_t:([< `V1 | `V2] as 'v) t) (id:([`River_input_device_v1], 'v, [`Server]) #Proxy.Handler.t) =
...
module River_input_device_v1 = struct
  ...
  class virtual ['v] _handlers_unsafe = object (_self : (_, 'v, _) #Proxy.Handler.t)
    ...
    method private virtual on_set_repeat_info : [> ] t -> rate:int32 -> delay:int32 -> unit
    
    method private virtual on_set_scroll_factor : [> ] t -> factor:Fixed.t -> unit
    
    method private virtual on_map_to_output : [> ] t -> output:([`Wl_output], [> Imports.Wl_output.versions], [`Server]) Proxy.t option ->
                                              unit
    
    method private virtual on_map_to_rectangle : [> ] t -> x:int32 -> y:int32 -> width:int32 -> height:int32 -> unit
  ...
  class virtual ['v] v1 = object (_ : (_, 'v, _) #Proxy.Service_handler.t)
    ...
    method private virtual on_map_to_output : [> `V1 | `V2] t -> output:([`Wl_output], [> Imports.Wl_output.versions], [`Server]) Proxy.t option ->
                                              unit
    ...
    method private virtual on_map_to_rectangle : [> `V1 | `V2] t -> x:int32 -> y:int32 -> width:int32 ->
                                                 height:int32 -> unit
  ...
  class virtual ['v] v2 = object (_ : (_, 'v, _) #Proxy.Service_handler.t)
    ...
    method private virtual on_set_repeat_info : [> `V2] t -> rate:int32 -> delay:int32 -> unit
    ...
    method private virtual on_map_to_output : [> `V2] t -> output:([`Wl_output], [> Imports.Wl_output.versions], [`Server]) Proxy.t option ->
                                              unit
    ...
    method private virtual on_map_to_rectangle : [> `V2] t -> x:int32 -> y:int32 -> width:int32 -> height:int32 -> unit
