...
module River_window_manager_v1 = struct
  ...
  let requests = function
    ...
    | 5 ->
      ( "get_shell_surface"
      , [ "id", `New_ID (Some "river_shell_surface_v1")
...
module River_window_v1 = struct
  ...
  let requests = function
    ...
    | 8 ->
      ( "set_borders"
      , [ "edges", `Uint; "width", `Int; "r", `Uint; "g", `Uint; "b", `Uint; "a", `Uint ]
      )
    | 9 -> "set_tiled", [ "edges", `Uint ]
    | 10 ->
      ( "get_decoration_above"
      , [ "id", `New_ID (Some "river_decoration_v1")
        ; "surface", `Object (Some "wl_surface")
        ] )
    | 11 ->
  ...
  let events = function
    ...
    | 8 ->
      ...
      , [ "seat", `Object (Some "river_seat_v1"); "edges", `Uint ] )
...
module River_output_v1 = struct
  ...
  module Error = struct
    type t = Invalid_presentation_mode : t
...
module River_seat_v1 = struct
  ...
  let requests = function
    ...
    | 2 ->
      "focus_shell_surface", [ "shell_surface", `Object (Some "river_shell_surface_v1") ]
    | 3 -> "clear_focus", []
    | 4 -> "op_start_pointer", []
    | 5 -> "op_end", []
    | 6 ->
      ( "get_pointer_binding"
      , [ "id", `New_ID (Some "river_pointer_binding_v1")
        ; "button", `Uint
        ; "modifiers", `Uint
        ] )
  ...
  let events = function
    ...
    | 5 ->
      ...
      , [ "shell_surface", `Object (Some "river_shell_surface_v1") ] )
