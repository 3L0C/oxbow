...
module River_layer_shell_v1 = struct
  ...
  class virtual ['v] _handlers_unsafe =
    object (_self : (_, 'v, _) #Proxy.Handler.t)
      ...
      method
        private
        virtual on_get_output
        : [> ] t
          -> ([ `River_layer_shell_output_v1 ], 'v, [ `Server ]) Proxy.t
          -> output:
               ( [ `River_output_v1 ]
      ...
      method
        ...
        virtual on_get_seat
        : [> ] t
          -> ([ `River_layer_shell_seat_v1 ], 'v, [ `Server ]) Proxy.t
          -> seat:
               ( [ `River_seat_v1 ]
      ...
      method dispatch (_proxy : 'v t) _msg =
        ...
        | 1 ->
          let id : ([ `River_layer_shell_output_v1 ], _, _) Proxy.t =
            ...
            |> Proxy.Handler.accept_new
                 _proxy
                 (module Imports.River_layer_shell_output_v1)
          in
        ...
        | 2 ->
          let id : ([ `River_layer_shell_seat_v1 ], _, _) Proxy.t =
            Msg.get_int _msg
            |> Proxy.Handler.accept_new _proxy (module Imports.River_layer_shell_seat_v1)
          in
