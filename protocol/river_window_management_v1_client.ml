...
module River_window_manager_v1 = struct
  ...
  let get_shell_surface
        (_t : ([< `V1 | `V2 | `V3 | `V4 ] as 'v) t)
        (id : ([ `River_shell_surface_v1 ], 'v, [ `Client ]) #Proxy.Handler.t)
        ~(surface : ([ `Wl_surface ], _, [ `Client ]) Proxy.t)
    =
  ...
  class virtual ['v] _handlers_unsafe =
    object (_self : (_, 'v, _) #Proxy.Handler.t)
      ...
      method
        private
        virtual on_window
        : [> ] t -> ([ `River_window_v1 ], 'v, [ `Client ]) Proxy.t -> unit

      method
        private
        virtual on_output
        : [> ] t -> ([ `River_output_v1 ], 'v, [ `Client ]) Proxy.t -> unit

      method
        private
        virtual on_seat
        : [> ] t -> ([ `River_seat_v1 ], 'v, [ `Client ]) Proxy.t -> unit

      method dispatch (_proxy : 'v t) _msg =
        let _proxy = Proxy.cast_version _proxy in
        match Msg.op _msg with
        | 0 -> _self#on_unavailable _proxy
        | 1 -> _self#on_finished _proxy
        | 2 -> _self#on_manage_start _proxy
        | 3 -> _self#on_render_start _proxy
        | 4 -> _self#on_session_locked _proxy
        | 5 -> _self#on_session_unlocked _proxy
        | 6 ->
          let id : ([ `River_window_v1 ], _, _) Proxy.t =
            Msg.get_int _msg
            |> Proxy.Handler.accept_new _proxy (module Imports.River_window_v1)
          in
          _self#on_window _proxy id
        | 7 ->
          let id : ([ `River_output_v1 ], _, _) Proxy.t =
            Msg.get_int _msg
            |> Proxy.Handler.accept_new _proxy (module Imports.River_output_v1)
          in
          _self#on_output _proxy id
        | 8 ->
          let id : ([ `River_seat_v1 ], _, _) Proxy.t =
            Msg.get_int _msg
            |> Proxy.Handler.accept_new _proxy (module Imports.River_seat_v1)
          in
  ...
  class virtual ['v] v1 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        ...
        virtual on_window
        : [> `V1 | `V2 | `V3 | `V4 ] t
          -> ([ `River_window_v1 ], 'v, [ `Client ]) Proxy.t
          -> unit
      ...
      method
        ...
        virtual on_output
        : [> `V1 | `V2 | `V3 | `V4 ] t
          -> ([ `River_output_v1 ], 'v, [ `Client ]) Proxy.t
          -> unit
      ...
      method
        ...
        virtual on_seat
        : [> `V1 | `V2 | `V3 | `V4 ] t
          -> ([ `River_seat_v1 ], 'v, [ `Client ]) Proxy.t
          -> unit
  ...
  class virtual ['v] v2 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_seat
        : [> `V2 | `V3 | `V4 ] t -> ([ `River_seat_v1 ], 'v, [ `Client ]) Proxy.t -> unit
  ...
  class virtual ['v] v3 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_window
        : [> `V3 | `V4 ] t -> ([ `River_window_v1 ], 'v, [ `Client ]) Proxy.t -> unit
      ...
      method
        private
        virtual on_output
        : [> `V3 | `V4 ] t -> ([ `River_output_v1 ], 'v, [ `Client ]) Proxy.t -> unit
      ...
      method
        private
        virtual on_seat
        : [> `V3 | `V4 ] t -> ([ `River_seat_v1 ], 'v, [ `Client ]) Proxy.t -> unit
  ...
  class virtual ['v] v4 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_window
        : [> `V4 ] t -> ([ `River_window_v1 ], 'v, [ `Client ]) Proxy.t -> unit
      ...
      method
        private
        virtual on_output
        : [> `V4 ] t -> ([ `River_output_v1 ], 'v, [ `Client ]) Proxy.t -> unit
      ...
      method
        private
        virtual on_seat
        : [> `V4 ] t -> ([ `River_seat_v1 ], 'v, [ `Client ]) Proxy.t -> unit
...
module River_window_v1 = struct
  ...
  (** Create a decoration below the window in z-order.
      ...
      Providing a wl_surface which already has a role or already has a buffer
      attached or committed is a protocol error. *)
  let get_decoration_below
        (_t : ([< `V1 | `V2 | `V3 | `V4 ] as 'v) t)
        (id : ([ `River_decoration_v1 ], 'v, [ `Client ]) #Proxy.Handler.t)
        ~(surface : ([ `Wl_surface ], _, [ `Client ]) Proxy.t)
    =
    let __id = Proxy.spawn _t id in
  ...
  let get_node
        (_t : ([< `V1 | `V2 | `V3 | `V4 ] as 'v) t)
        (id : ([ `River_node_v1 ], 'v, [ `Client ]) #Proxy.Handler.t)
    =
    let __id = Proxy.spawn _t id in
  ...
  class virtual ['v] _handlers_unsafe =
    object (_self : (_, 'v, _) #Proxy.Handler.t)
      ...
      method
        private
        virtual on_decoration_hint
        : [> ] t -> hint:Imports.River_window_v1.Decoration_hint.t -> unit

      method
        private
        virtual on_pointer_move_requested
        : [> ] t
          -> seat:
               ( [ `River_seat_v1 ]
                 , [> Imports.River_seat_v1.versions ]
                 , [ `Client ] )
                 Proxy.t
          -> unit
      ...
      method
        private
        virtual on_pointer_resize_requested
        : [> ] t
          -> seat:
               ( [ `River_seat_v1 ]
                 , [> Imports.River_seat_v1.versions ]
      ...
      method
        private
        virtual on_show_window_menu_requested
        : [> ] t -> x:int32 -> y:int32 -> unit
      ...
      method
        private
        virtual on_fullscreen_requested
        : [> ] t
          -> output:
               ( [ `River_output_v1 ]
      ...
      method
        private
        virtual on_presentation_hint
        : [> ] t -> hint:Imports.River_output_v1.Presentation_mode.t -> unit
      ...
      method dispatch (_proxy : 'v t) _msg =
        ...
        | 6 ->
          let hint =
            Msg.get_int _msg |> Imports.River_window_v1.Decoration_hint.of_int32
          in
        ...
        | 10 -> _self#on_maximize_requested _proxy
        | 11 -> _self#on_unmaximize_requested _proxy
        | 12 ->
        ...
        | 13 -> _self#on_exit_fullscreen_requested _proxy
        | 14 -> _self#on_minimize_requested _proxy
        | 15 ->
  ...
  class virtual ['v] v1 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_app_id
        : [> `V1 | `V2 | `V3 | `V4 ] t -> app_id:string option -> unit
      ...
      method
        private
        virtual on_title
        : [> `V1 | `V2 | `V3 | `V4 ] t -> title:string option -> unit
      ...
      method
        ...
        virtual on_decoration_hint
        : [> `V1 | `V2 | `V3 | `V4 ] t
          -> hint:Imports.River_window_v1.Decoration_hint.t
          -> unit
      ...
      method
        private
        virtual on_unmaximize_requested
        : [> `V1 | `V2 | `V3 | `V4 ] t -> unit
      ...
      method
        private
        virtual on_exit_fullscreen_requested
        : [> `V1 | `V2 | `V3 | `V4 ] t -> unit
      ...
      method
        private
        virtual on_unreliable_pid
        : [> `V2 | `V3 | `V4 ] t -> unreliable_pid:int32 -> unit
      ...
      method
        private
        virtual on_presentation_hint
        : [> `V4 ] t -> hint:Imports.River_output_v1.Presentation_mode.t -> unit
  ...
  class virtual ['v] v2 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_app_id
        : [> `V2 | `V3 | `V4 ] t -> app_id:string option -> unit
      ...
      method
        private
        virtual on_title
        : [> `V2 | `V3 | `V4 ] t -> title:string option -> unit
      ...
      method
        private
        virtual on_decoration_hint
        : [> `V2 | `V3 | `V4 ] t -> hint:Imports.River_window_v1.Decoration_hint.t -> unit
  ...
  class virtual ['v] v3 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_decoration_hint
        : [> `V3 | `V4 ] t -> hint:Imports.River_window_v1.Decoration_hint.t -> unit
      ...
      method
        private
        virtual on_unreliable_pid
        : [> `V3 | `V4 ] t -> unreliable_pid:int32 -> unit
  ...
  class virtual ['v] v4 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_decoration_hint
        : [> `V4 ] t -> hint:Imports.River_window_v1.Decoration_hint.t -> unit
      ...
      method
        private
        virtual on_unreliable_pid
        : [> `V4 ] t -> unreliable_pid:int32 -> unit
...
module River_node_v1 = struct
  ...
  let place_below
        (_t : ([< `V1 | `V2 | `V3 | `V4 ] as 'v) t)
        ~(other : ([ `River_node_v1 ], _, [ `Client ]) Proxy.t)
    =
...
module River_output_v1 = struct
  ...
  class virtual ['v] v1 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_wl_output
        : [> `V1 | `V2 | `V3 | `V4 ] t -> name:int32 -> unit
...
module River_seat_v1 = struct
  ...
  let get_pointer_binding
        (_t : ([< `V1 | `V2 | `V3 | `V4 ] as 'v) t)
        (id : ([ `River_pointer_binding_v1 ], 'v, [ `Client ]) #Proxy.Handler.t)
        ~button
        ~modifiers
    =
    let __id = Proxy.spawn _t id in
  ...
  let focus_window
        (_t : ([< `V1 | `V2 | `V3 | `V4 ] as 'v) t)
        ~(window : ([ `River_window_v1 ], _, [ `Client ]) Proxy.t)
    =
    let _msg = Proxy.alloc _t ~op:1 ~ints:1 ~strings:[] ~arrays:[] in
  ...
  class virtual ['v] _handlers_unsafe =
    object (_self : (_, 'v, _) #Proxy.Handler.t)
      ...
      method
        private
        virtual on_shell_surface_interaction
        : [> ] t
          -> shell_surface:
      ...
      method dispatch (_proxy : 'v t) _msg =
        ...
        | 3 -> _self#on_pointer_leave _proxy
        | 4 ->
          let window : ([ `River_window_v1 ], _, _) Proxy.t =
            let (Proxy.Proxy p) = Msg.get_int _msg |> Proxy.lookup_other _proxy in
            match Proxy.ty p with
  ...
  class virtual ['v] v1 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_op_delta
        : [> `V1 | `V2 | `V3 | `V4 ] t -> dx:int32 -> dy:int32 -> unit
  ...
  class virtual ['v] v2 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_op_delta
        : [> `V2 | `V3 | `V4 ] t -> dx:int32 -> dy:int32 -> unit
  ...
  class virtual ['v] v3 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_op_delta
        : [> `V3 | `V4 ] t -> dx:int32 -> dy:int32 -> unit
