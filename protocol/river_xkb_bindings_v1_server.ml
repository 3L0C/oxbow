  ...
  class virtual ['v] _handlers_unsafe =
    object (_self : (_, 'v, _) #Proxy.Handler.t)
        ...
        : [> ] t
          -> seat:
               ( [ `River_seat_v1 ]
                 ...
                 , [ `Server ] )
                 Proxy.t
          -> ([ `River_xkb_binding_v1 ], 'v, [ `Server ]) Proxy.t
          -> keysym:int32
      ...
      method
        ...
        virtual on_get_seat
        : [> ] t
          -> ([ `River_xkb_bindings_seat_v1 ], 'v, [ `Server ]) Proxy.t
          -> seat:
               ( [ `River_seat_v1 ]
                 , [> Imports.River_seat_v1.versions ]
                 , [ `Server ] )
      ...
      method dispatch (_proxy : 'v t) _msg =
        ...
        | 1 ->
          ...
          let id : ([ `River_xkb_binding_v1 ], _, _) Proxy.t =
            Msg.get_int _msg
            |> Proxy.Handler.accept_new _proxy (module Imports.River_xkb_binding_v1)
          in
        ...
        | 2 ->
          let id : ([ `River_xkb_bindings_seat_v1 ], _, _) Proxy.t =
            Msg.get_int _msg
            |> Proxy.Handler.accept_new _proxy (module Imports.River_xkb_bindings_seat_v1)
          in
          let seat : ([ `River_seat_v1 ], _, _) Proxy.t =
            let (Proxy.Proxy p) = Msg.get_int _msg |> Proxy.lookup_other _proxy in
            match Proxy.ty p with
...
module River_xkb_binding_v1 = struct
  ...
  class virtual ['v] _handlers_unsafe =
    object (_self : (_, 'v, _) #Proxy.Handler.t)
      ...
      method dispatch (_proxy : 'v t) _msg =
        ...
        | 2 -> _self#on_enable _proxy
        | 3 -> _self#on_disable _proxy
        | _ -> assert false
    end
  ...
  class virtual ['v] v1 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_set_layout_override
        : [> `V1 | `V2 | `V3 ] t -> layout:int32 -> unit
...
module River_xkb_bindings_seat_v1 = struct
  ...
  class virtual ['v] _handlers_unsafe =
    object (_self : (_, 'v, _) #Proxy.Handler.t)
      ...
      method
        private
        virtual on_modifiers_watch
        : [> ] t -> modifiers:Imports.River_seat_v1.Modifiers.t -> unit
      ...
      method dispatch (_proxy : 'v t) _msg =
        ...
        | 0 ->
          Proxy.shutdown_recv _proxy;
          _self#on_destroy _proxy
        | 1 -> _self#on_ensure_next_key_eaten _proxy
        | 2 -> _self#on_cancel_ensure_next_key_eaten _proxy
        | 3 ->
          let modifiers = Msg.get_int _msg |> Imports.River_seat_v1.Modifiers.of_int32 in
  ...
  class virtual ['v] v1 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_modifiers_watch
        : [> `V3 ] t -> modifiers:Imports.River_seat_v1.Modifiers.t -> unit
