  ...
  class virtual ['v] _handlers_unsafe =
    object (_self : (_, 'v, _) #Proxy.Handler.t)
      ...
      method
        ...
        : [> ] t -> ([ `River_input_device_v1 ], 'v, [ `Client ]) Proxy.t -> unit
      ...
      method dispatch (_proxy : 'v t) _msg =
        ...
        | 1 ->
          let id : ([ `River_input_device_v1 ], _, _) Proxy.t =
            Msg.get_int _msg
            |> Proxy.Handler.accept_new _proxy (module Imports.River_input_device_v1)
          in
  ...
  class virtual ['v] v1 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        ...
        virtual on_input_device
        : [> `V1 | `V2 ] t
          -> ([ `River_input_device_v1 ], 'v, [ `Client ]) Proxy.t
          -> unit
  ...
  class virtual ['v] v2 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_input_device
        : [> `V2 ] t -> ([ `River_input_device_v1 ], 'v, [ `Client ]) Proxy.t -> unit
...
module River_input_device_v1 = struct
  ...
  let map_to_output
        (_t : ([< `V1 | `V2 ] as 'v) t)
        ~(output : ([ `Wl_output ], _, [ `Client ]) Proxy.t option)
    =
  ...
  class virtual ['v] _handlers_unsafe =
    object (_self : (_, 'v, _) #Proxy.Handler.t)
      ...
      method
        private
        virtual on_type
        : [> ] t -> type_:Imports.River_input_device_v1.Type.t -> unit
  ...
  class virtual ['v] v1 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_type
        : [> `V1 | `V2 ] t -> type_:Imports.River_input_device_v1.Type.t -> unit
  ...
  class virtual ['v] v2 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_type
        : [> `V2 ] t -> type_:Imports.River_input_device_v1.Type.t -> unit
