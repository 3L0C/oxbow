...
module River_window_manager_v1 = struct
  ...
  let seat
        (_t : ([< `V1 | `V2 | `V3 | `V4 ] as 'v) t)
        (id : ([ `River_seat_v1 ], 'v, [ `Server ]) #Proxy.Handler.t)
    =
  ...
  let output
        (_t : ([< `V1 | `V2 | `V3 | `V4 ] as 'v) t)
        (id : ([ `River_output_v1 ], 'v, [ `Server ]) #Proxy.Handler.t)
    =
    let __id = Proxy.spawn _t id in
  ...
  let window
        (_t : ([< `V1 | `V2 | `V3 | `V4 ] as 'v) t)
        (id : ([ `River_window_v1 ], 'v, [ `Server ]) #Proxy.Handler.t)
    =
    let __id = Proxy.spawn _t id in
  ...
  class virtual ['v] _handlers_unsafe =
    object (_self : (_, 'v, _) #Proxy.Handler.t)
      ...
      method
        private
        virtual on_get_shell_surface
        : [> ] t
          -> ([ `River_shell_surface_v1 ], 'v, [ `Server ]) Proxy.t
          -> surface:
               ([ `Wl_surface ], [> Imports.Wl_surface.versions ], [ `Server ]) Proxy.t
          -> unit
      ...
      method dispatch (_proxy : 'v t) _msg =
        ...
        | 2 -> _self#on_manage_finish _proxy
        | 3 -> _self#on_manage_dirty _proxy
        | 4 -> _self#on_render_finish _proxy
        | 5 ->
          let id : ([ `River_shell_surface_v1 ], _, _) Proxy.t =
            Msg.get_int _msg
            |> Proxy.Handler.accept_new _proxy (module Imports.River_shell_surface_v1)
          in
        ...
        | 6 -> _self#on_exit_session _proxy
        | _ -> assert false
    end
...
module River_window_v1 = struct
  ...
  module Decoration_hint =
    River_window_management_v1_proto.River_window_v1.Decoration_hint
  ...
  (** Window requested that the window menu be shown.
      ...
      This event will be followed by a manage_start event after all other new
      state has been sent by the server. *)
  let show_window_menu_requested (_t : ([< `V1 | `V2 | `V3 | `V4 ] as 'v) t) ~x ~y =
  ...
  let parent
        (_t : ([< `V1 | `V2 | `V3 | `V4 ] as 'v) t)
        ~(parent : ([ `River_window_v1 ], _, [ `Server ]) Proxy.t option)
    =
  ...
  class virtual ['v] _handlers_unsafe =
    object (_self : (_, 'v, _) #Proxy.Handler.t)
      ...
      method
        private
        virtual on_get_node
        : [> ] t -> ([ `River_node_v1 ], 'v, [ `Server ]) Proxy.t -> unit

      method
        private
        virtual on_propose_dimensions
        : [> ] t -> width:int32 -> height:int32 -> unit
      ...
      method
        private
        virtual on_set_borders
        : [> ] t
          -> edges:Imports.River_window_v1.Edges.t
          -> width:int32
          -> r:int32
          -> g:int32
          -> b:int32
      ...
      method
        private
        virtual on_set_tiled
        : [> ] t -> edges:Imports.River_window_v1.Edges.t -> unit

      method
        private
        virtual on_get_decoration_above
        : [> ] t
          -> ([ `River_decoration_v1 ], 'v, [ `Server ]) Proxy.t
          -> surface:
               ([ `Wl_surface ], [> Imports.Wl_surface.versions ], [ `Server ]) Proxy.t
          -> unit
      ...
      method
        private
        virtual on_get_decoration_below
        : [> ] t
          -> ([ `River_decoration_v1 ], 'v, [ `Server ]) Proxy.t
          -> surface:
               ([ `Wl_surface ], [> Imports.Wl_surface.versions ], [ `Server ]) Proxy.t
      ...
      method
        private
        virtual on_set_capabilities
        : [> ] t -> caps:Imports.River_window_v1.Capabilities.t -> unit
      ...
      method
        private
        virtual on_fullscreen
        : [> ] t
          -> output:
               ( [ `River_output_v1 ]
                 , [> Imports.River_output_v1.versions ]
                 , [ `Server ] )
                 Proxy.t
          -> unit
      ...
      method
        private
        virtual on_set_clip_box
        : [> ] t -> x:int32 -> y:int32 -> width:int32 -> height:int32 -> unit

      method
        private
        virtual on_set_content_clip_box
        : [> ] t -> x:int32 -> y:int32 -> width:int32 -> height:int32 -> unit

      method
        private
        virtual on_set_dimension_bounds
        : [> ] t -> max_width:int32 -> max_height:int32 -> unit
      ...
      method dispatch (_proxy : 'v t) _msg =
        ...
        | 0 ->
          Proxy.shutdown_recv _proxy;
          _self#on_destroy _proxy
        | 1 -> _self#on_close _proxy
        | 2 ->
          let id : ([ `River_node_v1 ], _, _) Proxy.t =
            Msg.get_int _msg
            |> Proxy.Handler.accept_new _proxy (module Imports.River_node_v1)
          in
        ...
        | 4 -> _self#on_hide _proxy
        | 5 -> _self#on_show _proxy
        | 6 -> _self#on_use_csd _proxy
        | 7 -> _self#on_use_ssd _proxy
        | 8 ->
        ...
        | 10 ->
          let id : ([ `River_decoration_v1 ], _, _) Proxy.t =
            Msg.get_int _msg
            |> Proxy.Handler.accept_new _proxy (module Imports.River_decoration_v1)
          in
          let surface : ([ `Wl_surface ], _, _) Proxy.t =
            let (Proxy.Proxy p) = Msg.get_int _msg |> Proxy.lookup_other _proxy in
            match Proxy.ty p with
        ...
        | 12 -> _self#on_inform_resize_start _proxy
        | 13 -> _self#on_inform_resize_end _proxy
        | 14 ->
          let caps = Msg.get_int _msg |> Imports.River_window_v1.Capabilities.of_int32 in
          _self#on_set_capabilities _proxy ~caps
        | 15 -> _self#on_inform_maximized _proxy
        | 16 -> _self#on_inform_unmaximized _proxy
        | 17 -> _self#on_inform_fullscreen _proxy
        | 18 -> _self#on_inform_not_fullscreen _proxy
        | 19 ->
        ...
        | 20 -> _self#on_exit_fullscreen _proxy
        | 21 ->
  ...
  class virtual ['v] v1 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        ...
        virtual on_get_node
        : [> `V1 | `V2 | `V3 | `V4 ] t
          -> ([ `River_node_v1 ], 'v, [ `Server ]) Proxy.t
          -> unit
      ...
      method
        private
        virtual on_propose_dimensions
        : [> `V1 | `V2 | `V3 | `V4 ] t -> width:int32 -> height:int32 -> unit
      ...
      method
        private
        virtual on_set_tiled
        : [> `V1 | `V2 | `V3 | `V4 ] t -> edges:Imports.River_window_v1.Edges.t -> unit
      ...
      method
        ...
        virtual on_set_capabilities
        : [> `V1 | `V2 | `V3 | `V4 ] t
          -> caps:Imports.River_window_v1.Capabilities.t
          -> unit
      ...
      method
        private
        virtual on_inform_not_fullscreen
        : [> `V1 | `V2 | `V3 | `V4 ] t -> unit
      ...
      method
        private
        virtual on_set_content_clip_box
        : [> `V3 | `V4 ] t -> x:int32 -> y:int32 -> width:int32 -> height:int32 -> unit
      ...
      method
        private
        virtual on_set_dimension_bounds
        : [> `V4 ] t -> max_width:int32 -> max_height:int32 -> unit
  ...
  class virtual ['v] v2 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_get_node
        : [> `V2 | `V3 | `V4 ] t -> ([ `River_node_v1 ], 'v, [ `Server ]) Proxy.t -> unit
      ...
      method
        private
        virtual on_propose_dimensions
        : [> `V2 | `V3 | `V4 ] t -> width:int32 -> height:int32 -> unit
      ...
      method
        private
        virtual on_set_tiled
        : [> `V2 | `V3 | `V4 ] t -> edges:Imports.River_window_v1.Edges.t -> unit
      ...
      method
        private
        virtual on_set_capabilities
        : [> `V2 | `V3 | `V4 ] t -> caps:Imports.River_window_v1.Capabilities.t -> unit
  ...
  class virtual ['v] v3 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_get_node
        : [> `V3 | `V4 ] t -> ([ `River_node_v1 ], 'v, [ `Server ]) Proxy.t -> unit
      ...
      method
        private
        virtual on_propose_dimensions
        : [> `V3 | `V4 ] t -> width:int32 -> height:int32 -> unit
      ...
      method
        private
        virtual on_set_tiled
        : [> `V3 | `V4 ] t -> edges:Imports.River_window_v1.Edges.t -> unit
      ...
      method
        private
        virtual on_set_capabilities
        : [> `V3 | `V4 ] t -> caps:Imports.River_window_v1.Capabilities.t -> unit
  ...
  class virtual ['v] v4 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_get_node
        : [> `V4 ] t -> ([ `River_node_v1 ], 'v, [ `Server ]) Proxy.t -> unit
      ...
      method
        private
        virtual on_propose_dimensions
        : [> `V4 ] t -> width:int32 -> height:int32 -> unit
      ...
      method
        private
        virtual on_set_tiled
        : [> `V4 ] t -> edges:Imports.River_window_v1.Edges.t -> unit
      ...
      method
        private
        virtual on_set_capabilities
        : [> `V4 ] t -> caps:Imports.River_window_v1.Capabilities.t -> unit
      ...
      method
        private
        virtual on_set_clip_box
        : [> `V4 ] t -> x:int32 -> y:int32 -> width:int32 -> height:int32 -> unit
...
module River_decoration_v1 = struct
  ...
  class virtual ['v] _handlers_unsafe =
    object (_self : (_, 'v, _) #Proxy.Handler.t)
      ...
      method dispatch (_proxy : 'v t) _msg =
        ...
        | 2 -> _self#on_sync_next_commit _proxy
        | _ -> assert false
    end
  ...
  class virtual ['v] v1 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_set_offset
        : [> `V1 | `V2 | `V3 | `V4 ] t -> x:int32 -> y:int32 -> unit
  ...
  class virtual ['v] v2 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_set_offset
        : [> `V2 | `V3 | `V4 ] t -> x:int32 -> y:int32 -> unit
...
module River_node_v1 = struct
  ...
  class virtual ['v] _handlers_unsafe =
    object (_self : (_, 'v, _) #Proxy.Handler.t)
      ...
      method
        private
        virtual on_place_above
        : [> ] t
          -> other:
               ( [ `River_node_v1 ]
                 , [> Imports.River_node_v1.versions ]
                 , [ `Server ] )
                 Proxy.t
          -> unit
      ...
      method dispatch (_proxy : 'v t) _msg =
        ...
        | 2 -> _self#on_place_top _proxy
        | 3 -> _self#on_place_bottom _proxy
        | 4 ->
...
module River_output_v1 = struct
  ...
  module Presentation_mode =
    River_window_management_v1_proto.River_output_v1.Presentation_mode
  ...
  class virtual ['v] _handlers_unsafe =
    object (_self : (_, 'v, _) #Proxy.Handler.t)
      ...
      method
        private
        virtual on_set_presentation_mode
        : [> ] t -> mode:Imports.River_output_v1.Presentation_mode.t -> unit
      ...
      method dispatch (_proxy : 'v t) _msg =
        ...
        | 1 ->
          let mode =
            Msg.get_int _msg |> Imports.River_output_v1.Presentation_mode.of_int32
          in
  ...
  class virtual ['v] v1 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_set_presentation_mode
        : [> `V4 ] t -> mode:Imports.River_output_v1.Presentation_mode.t -> unit
...
module River_seat_v1 = struct
  ...
  class virtual ['v] _handlers_unsafe =
    object (_self : (_, 'v, _) #Proxy.Handler.t)
      ...
      method
        private
        virtual on_focus_window
        : [> ] t
          -> window:
               ( [ `River_window_v1 ]
                 , [> Imports.River_window_v1.versions ]
                 , [ `Server ] )
                 Proxy.t
          -> unit
      ...
      method
        private
        virtual on_focus_shell_surface
        : [> ] t
          -> shell_surface:
      ...
      method
        private
        virtual on_get_pointer_binding
        : [> ] t
          -> ([ `River_pointer_binding_v1 ], 'v, [ `Server ]) Proxy.t
          -> button:int32
      ...
      method
        private
        virtual on_set_xcursor_theme
        : [> ] t -> name:string -> size:int32 -> unit
      ...
      method dispatch (_proxy : 'v t) _msg =
        ...
        | 3 -> _self#on_clear_focus _proxy
        | 4 -> _self#on_op_start_pointer _proxy
        | 5 -> _self#on_op_end _proxy
        | 6 ->
          let id : ([ `River_pointer_binding_v1 ], _, _) Proxy.t =
            Msg.get_int _msg
            |> Proxy.Handler.accept_new _proxy (module Imports.River_pointer_binding_v1)
          in
  ...
  class virtual ['v] v1 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_set_xcursor_theme
        : [> `V2 | `V3 | `V4 ] t -> name:string -> size:int32 -> unit
  ...
  class virtual ['v] v3 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_set_xcursor_theme
        : [> `V3 | `V4 ] t -> name:string -> size:int32 -> unit
  ...
  class virtual ['v] v4 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_set_xcursor_theme
        : [> `V4 ] t -> name:string -> size:int32 -> unit
    ...
    object (_self : (_, 'v, _) #Proxy.Handler.t)
      ...
      method dispatch (_proxy : 'v t) _msg =
        ...
        | 0 ->
          Proxy.shutdown_recv _proxy;
          _self#on_destroy _proxy
        | 1 -> _self#on_enable _proxy
        | 2 -> _self#on_disable _proxy
        | _ -> assert false
    end
