...
module River_libinput_config_v1 = struct
  ...
  let create_accel_config
        (_t : ([< `V1 | `V2 ] as 'v) t)
        (id : ([ `River_libinput_accel_config_v1 ], 'v, [ `Client ]) #Proxy.Handler.t)
        ~profile
    =
  ...
  class virtual ['v] _handlers_unsafe =
    object (_self : (_, 'v, _) #Proxy.Handler.t)
      ...
      method
        private
        virtual on_libinput_device
        : [> ] t -> ([ `River_libinput_device_v1 ], 'v, [ `Client ]) Proxy.t -> unit

      method dispatch (_proxy : 'v t) _msg =
        let _proxy = Proxy.cast_version _proxy in
        match Msg.op _msg with
        | 0 -> _self#on_finished _proxy
        | 1 ->
          let id : ([ `River_libinput_device_v1 ], _, _) Proxy.t =
            Msg.get_int _msg
            |> Proxy.Handler.accept_new _proxy (module Imports.River_libinput_device_v1)
          in
  ...
  class virtual ['v] v1 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        ...
        virtual on_libinput_device
        : [> `V1 | `V2 ] t
          -> ([ `River_libinput_device_v1 ], 'v, [ `Client ]) Proxy.t
          -> unit
  ...
  class virtual ['v] v2 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_libinput_device
        : [> `V2 ] t -> ([ `River_libinput_device_v1 ], 'v, [ `Client ]) Proxy.t -> unit
...
module River_libinput_device_v1 = struct
  ...
  let set_rotation
        (_t : ([< `V1 | `V2 ] as 'v) t)
        (result : ([ `River_libinput_result_v1 ], 'v, [ `Client ]) #Proxy.Handler.t)
        ~angle
    =
  ...
  let set_clickfinger_button_map
        (_t : ([< `V1 | `V2 ] as 'v) t)
        (result : ([ `River_libinput_result_v1 ], 'v, [ `Client ]) #Proxy.Handler.t)
        ~button_map
    =
  ...
  let apply_accel_config
        (_t : ([< `V1 | `V2 ] as 'v) t)
        (result : ([ `River_libinput_result_v1 ], 'v, [ `Client ]) #Proxy.Handler.t)
        ~(config : ([ `River_libinput_accel_config_v1 ], _, [ `Client ]) Proxy.t)
    =
    let __result = Proxy.spawn _t result in
  ...
  class virtual ['v] _handlers_unsafe =
    object (_self : (_, 'v, _) #Proxy.Handler.t)
      ...
      method
        private
        virtual on_send_events_support
        : [> ] t -> modes:Imports.River_libinput_device_v1.Send_events_modes.t -> unit

      method
        private
        virtual on_send_events_default
        : [> ] t -> mode:Imports.River_libinput_device_v1.Send_events_modes.t -> unit

      method
        private
        virtual on_send_events_current
        : [> ] t -> mode:Imports.River_libinput_device_v1.Send_events_modes.t -> unit
      ...
      method
        private
        virtual on_tap_default
        : [> ] t -> state:Imports.River_libinput_device_v1.Tap_state.t -> unit

      method
        private
        virtual on_tap_current
        : [> ] t -> state:Imports.River_libinput_device_v1.Tap_state.t -> unit

      method
        private
        virtual on_tap_button_map_default
        : [> ] t -> button_map:Imports.River_libinput_device_v1.Tap_button_map.t -> unit

      method
        private
        virtual on_tap_button_map_current
        : [> ] t -> button_map:Imports.River_libinput_device_v1.Tap_button_map.t -> unit

      method
        private
        virtual on_drag_default
        : [> ] t -> state:Imports.River_libinput_device_v1.Drag_state.t -> unit

      method
        private
        virtual on_drag_current
        : [> ] t -> state:Imports.River_libinput_device_v1.Drag_state.t -> unit

      method
        private
        virtual on_drag_lock_default
        : [> ] t -> state:Imports.River_libinput_device_v1.Drag_lock_state.t -> unit

      method
        private
        virtual on_drag_lock_current
        : [> ] t -> state:Imports.River_libinput_device_v1.Drag_lock_state.t -> unit

      method
        private
        virtual on_three_finger_drag_support
        : [> ] t -> finger_count:int32 -> unit

      method
        private
        virtual on_three_finger_drag_default
        : [> ] t
      ...
      method
        private
        virtual on_three_finger_drag_current
        : [> ] t
          -> state:Imports.River_libinput_device_v1.Three_finger_drag_state.t
          -> unit
      ...
      method
        private
        virtual on_calibration_matrix_support
        : [> ] t -> supported:int32 -> unit

      method
        private
        virtual on_calibration_matrix_default
        : [> ] t -> matrix:string -> unit

      method
        private
        virtual on_calibration_matrix_current
        : [> ] t -> matrix:string -> unit

      method
        private
        virtual on_accel_profiles_support
        : [> ] t -> profiles:Imports.River_libinput_device_v1.Accel_profiles.t -> unit

      method
        private
        virtual on_accel_profile_default
        : [> ] t -> profile:Imports.River_libinput_device_v1.Accel_profile.t -> unit

      method
        private
        virtual on_accel_profile_current
        : [> ] t -> profile:Imports.River_libinput_device_v1.Accel_profile.t -> unit
      ...
      method
        private
        virtual on_natural_scroll_default
        : [> ] t -> state:Imports.River_libinput_device_v1.Natural_scroll_state.t -> unit

      method
        private
        virtual on_natural_scroll_current
        : [> ] t -> state:Imports.River_libinput_device_v1.Natural_scroll_state.t -> unit
      ...
      method
        private
        virtual on_left_handed_default
        : [> ] t -> state:Imports.River_libinput_device_v1.Left_handed_state.t -> unit

      method
        private
        virtual on_left_handed_current
        : [> ] t -> state:Imports.River_libinput_device_v1.Left_handed_state.t -> unit

      method
        private
        virtual on_click_method_support
        : [> ] t -> methods:Imports.River_libinput_device_v1.Click_methods.t -> unit

      method
        private
        virtual on_click_method_default
        : [> ] t -> method_:Imports.River_libinput_device_v1.Click_method.t -> unit

      method
        private
        virtual on_click_method_current
        : [> ] t -> method_:Imports.River_libinput_device_v1.Click_method.t -> unit

      method
        private
        virtual on_clickfinger_button_map_default
        : [> ] t
      ...
      method
        private
        virtual on_clickfinger_button_map_current
        : [> ] t
          -> button_map:Imports.River_libinput_device_v1.Clickfinger_button_map.t
          -> unit
      ...
      method
        private
        virtual on_middle_emulation_support
        : [> ] t -> supported:int32 -> unit

      method
        private
        virtual on_middle_emulation_default
        : [> ] t
      ...
      method
        private
        virtual on_middle_emulation_current
        : [> ] t
          -> state:Imports.River_libinput_device_v1.Middle_emulation_state.t
          -> unit
      ...
      method
        private
        virtual on_scroll_method_support
        : [> ] t -> methods:Imports.River_libinput_device_v1.Scroll_methods.t -> unit

      method
        private
        virtual on_scroll_method_default
        : [> ] t -> method_:Imports.River_libinput_device_v1.Scroll_method.t -> unit

      method
        private
        virtual on_scroll_method_current
        : [> ] t -> method_:Imports.River_libinput_device_v1.Scroll_method.t -> unit
      ...
      method
        private
        virtual on_scroll_button_lock_default
        : [> ] t
      ...
      method
        private
        virtual on_scroll_button_lock_current
        : [> ] t
          -> state:Imports.River_libinput_device_v1.Scroll_button_lock_state.t
          -> unit
      ...
      method
        private
        virtual on_dwt_default
        : [> ] t -> state:Imports.River_libinput_device_v1.Dwt_state.t -> unit

      method
        private
        virtual on_dwt_current
        : [> ] t -> state:Imports.River_libinput_device_v1.Dwt_state.t -> unit
      ...
      method
        private
        virtual on_dwtp_default
        : [> ] t -> state:Imports.River_libinput_device_v1.Dwtp_state.t -> unit

      method
        private
        virtual on_dwtp_current
        : [> ] t -> state:Imports.River_libinput_device_v1.Dwtp_state.t -> unit
      ...
      method dispatch (_proxy : 'v t) _msg =
        ...
        | 20 ->
          let profiles =
            Msg.get_int _msg |> Imports.River_libinput_device_v1.Accel_profiles.of_int32
          in
        ...
        | 31 ->
          let methods =
            Msg.get_int _msg |> Imports.River_libinput_device_v1.Click_methods.of_int32
          in
        ...
        | 39 ->
          let methods =
            Msg.get_int _msg |> Imports.River_libinput_device_v1.Scroll_methods.of_int32
          in
  ...
  class virtual ['v] v1 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_tap_support
        : [> `V1 | `V2 ] t -> finger_count:int32 -> unit
      ...
      method
        private
        virtual on_tap_default
        : [> `V1 | `V2 ] t -> state:Imports.River_libinput_device_v1.Tap_state.t -> unit
      ...
      method
        private
        virtual on_drag_default
        : [> `V1 | `V2 ] t -> state:Imports.River_libinput_device_v1.Drag_state.t -> unit
      ...
      method
        private
        virtual on_accel_speed_default
        : [> `V1 | `V2 ] t -> speed:string -> unit
      ...
      method
        private
        virtual on_accel_speed_current
        : [> `V1 | `V2 ] t -> speed:string -> unit
      ...
      method
        private
        virtual on_natural_scroll_support
        : [> `V1 | `V2 ] t -> supported:int32 -> unit
      ...
      method
        private
        virtual on_left_handed_support
        : [> `V1 | `V2 ] t -> supported:int32 -> unit
      ...
      method
        private
        virtual on_scroll_button_default
        : [> `V1 | `V2 ] t -> button:int32 -> unit
      ...
      method
        private
        virtual on_scroll_button_current
        : [> `V1 | `V2 ] t -> button:int32 -> unit
      ...
      method
        private
        virtual on_dwt_default
        : [> `V1 | `V2 ] t -> state:Imports.River_libinput_device_v1.Dwt_state.t -> unit
      ...
      method
        private
        virtual on_dwtp_default
        : [> `V1 | `V2 ] t -> state:Imports.River_libinput_device_v1.Dwtp_state.t -> unit
  ...
  class virtual ['v] v2 =
    object (_ : (_, 'v, _) #Proxy.Service_handler.t)
      ...
      method
        private
        virtual on_send_events_support
        : [> `V2 ] t -> modes:Imports.River_libinput_device_v1.Send_events_modes.t -> unit
      ...
      method
        private
        virtual on_send_events_default
        : [> `V2 ] t -> mode:Imports.River_libinput_device_v1.Send_events_modes.t -> unit
      ...
      method
        private
        virtual on_tap_default
        : [> `V2 ] t -> state:Imports.River_libinput_device_v1.Tap_state.t -> unit
      ...
      method
        private
        virtual on_drag_default
        : [> `V2 ] t -> state:Imports.River_libinput_device_v1.Drag_state.t -> unit
      ...
      method
        private
        virtual on_drag_lock_default
        : [> `V2 ] t -> state:Imports.River_libinput_device_v1.Drag_lock_state.t -> unit
      ...
      method
        private
        virtual on_accel_profiles_support
        : [> `V2 ] t -> profiles:Imports.River_libinput_device_v1.Accel_profiles.t -> unit
      ...
      method
        private
        virtual on_accel_profile_default
        : [> `V2 ] t -> profile:Imports.River_libinput_device_v1.Accel_profile.t -> unit
      ...
      method
        private
        virtual on_left_handed_default
        : [> `V2 ] t -> state:Imports.River_libinput_device_v1.Left_handed_state.t -> unit
      ...
      method
        private
        virtual on_click_method_support
        : [> `V2 ] t -> methods:Imports.River_libinput_device_v1.Click_methods.t -> unit
      ...
      method
        private
        virtual on_click_method_default
        : [> `V2 ] t -> method_:Imports.River_libinput_device_v1.Click_method.t -> unit
      ...
      method
        private
        virtual on_scroll_method_support
        : [> `V2 ] t -> methods:Imports.River_libinput_device_v1.Scroll_methods.t -> unit
      ...
      method
        private
        virtual on_scroll_method_default
        : [> `V2 ] t -> method_:Imports.River_libinput_device_v1.Scroll_method.t -> unit
      ...
      method
        private
        virtual on_dwt_default
        : [> `V2 ] t -> state:Imports.River_libinput_device_v1.Dwt_state.t -> unit
      ...
      method
        private
        virtual on_dwtp_default
        : [> `V2 ] t -> state:Imports.River_libinput_device_v1.Dwtp_state.t -> unit
...
module River_libinput_accel_config_v1 = struct
  ...
  let set_points
    ...
    =
    let __result = Proxy.spawn _t result in
    let _msg = Proxy.alloc _t ~op:1 ~ints:4 ~strings:[] ~arrays:[ step; points ] in
    Msg.add_int _msg (Proxy.id __result);
