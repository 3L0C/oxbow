...
module River_layer_shell_v1 = struct
  ...
  let get_seat (_t:([< `V1] as 'v) t) (id:([`River_layer_shell_seat_v1], 'v, [`Client]) #Proxy.Handler.t) ~(seat:([`River_seat_v1], _, [`Client]) Proxy.t) =
  ...
  let get_output (_t:([< `V1] as 'v) t) (id:([`River_layer_shell_output_v1], 'v, [`Client]) #Proxy.Handler.t) ~(output:([`River_output_v1], _, [`Client]) Proxy.t) =
    let __id = Proxy.spawn _t id in
...
module River_layer_shell_output_v1 = struct
  ...
  class virtual ['v] _handlers_unsafe = object (_self : (_, 'v, _) #Proxy.Handler.t)
    ...
    method private virtual on_non_exclusive_area : [> ] t -> x:int32 -> y:int32 -> width:int32 -> height:int32 -> unit
  ...
  class virtual ['v] v1 = object (_ : (_, 'v, _) #Proxy.Service_handler.t)
    ...
    inherit [[< `V1] as 'v] _handlers_unsafe
    (**/**)
    method private virtual on_non_exclusive_area : [> `V1] t -> x:int32 -> y:int32 -> width:int32 -> height:int32 ->
                                                   unit
...
module River_layer_shell_seat_v1 = struct
  ...
  class virtual ['v] _handlers_unsafe = object (_self : (_, 'v, _) #Proxy.Handler.t)
    ...
    method dispatch (_proxy : 'v t) _msg =
      ...
      match Msg.op _msg with
      | 0 ->
        _self#on_focus_exclusive _proxy 
      | 1 ->
        _self#on_focus_non_exclusive _proxy 
      | 2 ->
        _self#on_focus_none _proxy 
      | _ -> assert false
  end
  (**/**)
