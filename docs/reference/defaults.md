...
| `oxctl border color swallowing`  | `#98BB6C` |
| `oxctl border color captured`    | `#957FB8` |
...
| `Super+space`     | Moves the focused window to top of the stack, or swap with the next window if already at the top (i.e., zoom) |
